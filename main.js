...
function gotResults(error, results) {
  if (error) {
    ...
    if (results[0].label == "Barking") {
      img.src = 'https://i.gifer.com/embedded/download/ZNv5.gif';
      dog = dog+1;
    } else if (results[0].label == "Meowing") {
      img.src = 'https://c.tenor.com/CH9a7exGiFIAAAAM/cat-mute.gif';
      cat = cat + 1;
    } else{
      img.src = 'https://c.tenor.com/3_xuAnSNMg0AAAAj/little-bad-bear-dancing-listening.gif';
    }
  }
}
